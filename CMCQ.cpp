...
CMCQ::CMCQ(CMCQ& mcq)
{
  ...
  strcpy(this->Description, mcq.GetDescription());
  this->Options = new char*[4];
  for(int i = 0; i < 4; i++)
  {
  ...
  strcpy(this->Answer, mcq.GetAnswer());
}
CMCQ::~CMCQ()
{
...
CMCQ& CMCQ::SetOption(char* option, int num)
{
  ...
  strcpy(this->Options[num - 1], option);
  return *this;
}
